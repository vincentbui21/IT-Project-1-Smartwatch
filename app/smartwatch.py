...
def sound_and_camera_receive(client_socket:socket.socket):
	"""
	...
	"""
	sound_thread = threading.Thread(target=sound_receive, args=(client_socket,), daemon=True)
	sound_thread.start()
...
if __name__ == "__main__":
	...
	sound_and_camera_receive(client_socket)
